...
export const check = (
  ...
  export const durgStore = async (
    ...
    try {
      await axios.get("http://apis.data.go.kr/B551182/pharmacyInfoService/getParmacyBasisList?serviceKey="+process.env.API_KEY+"&pageNo=1&numOfRows=10&xPos=126.877916&yPos=37.481411&radius=1000")
             .then(data => {
               logger.info(data)
