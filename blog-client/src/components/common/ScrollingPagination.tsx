...
export default class ScrollingPagination extends React.Component<ScrollingPaginationProps, any> {
    loadMore = () => {
    ...
    componentDidUpdate(prevProps: ScrollingPaginationProps) {
        if (prevProps.lastCursor !== this.props.lastCursor && this.props.lastCursor) {
            this.props.onPrefetch(this.props.lastCursor);
        }
    }
    public render() {
